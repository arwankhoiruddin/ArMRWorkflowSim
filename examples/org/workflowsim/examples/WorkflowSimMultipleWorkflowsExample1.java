...
public class WorkflowSimMultipleWorkflowsExample1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            daxPaths.add(currentDir + "/config/dax/Montage_100.xml");
            daxPaths.add(currentDir + "/config/dax/Montage_25.xml");
            daxPaths.add(currentDir + "/config/dax/Montage_1000.xml");
            /**
